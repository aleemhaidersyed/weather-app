...
function displayWeather(data, city, country) {
    ...
    const weatherHTML = `<div class='weather-header'><h2>${city}, ${country}</h2><p class='temperature'>${temp}°C</p><p class='condition'>${condition}</p><p class='feels-like'>Feels like: ${feelsLike}°C</p></div><div class='weather-details'><div class='detail'><span>Humidity</span><span>${humidity}%</span></div><div class='detail'><span>Wind Speed</span><span>${windSpeed} km/h</span></div><div class='detail'><span>Pressure</span><span>${pressure} hPa</span></div></div>`;
